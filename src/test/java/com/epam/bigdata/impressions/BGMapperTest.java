...
//    private MapDriver<LongWritable, Text, Text, LineIsImpressionValue> mapDriver;

    @Before
    public void setUp() {
//        BGMapper mapper = new BGMapper();
//        mapDriver = new MapDriver<LongWritable, Text, Text, LineIsImpressionValue>();
...
//        mapDriver.withOutput(new Text("59.40.102.*"), new LineIsImpressionValue(1L, 254));
